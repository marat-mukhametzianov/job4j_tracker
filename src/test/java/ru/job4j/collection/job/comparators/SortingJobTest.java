...
public class SortingJobTest {
    ...
    public void compareByNameAsc() {
        List<Job> jobs = List.of(new Job("three", 3), new Job("one", 1), new Job("two", 2));
    ...
    public void compareAscNameAscPriority() {
        List<Job> jobs = List.of(new Job("two", 3), new Job("one", 1), new Job("two", 2));
        assertThat(complexSorting(
                new SortByNameAsc(), new SortByPriorityAsc(), jobs).get(2), is(new Job("two", 3)));
    }
    ...
    public void compareAscNameDescPriority() {
        List<Job> jobs = List.of(new Job("two", 3), new Job("one", 1), new Job("two", 2));
        assertThat(complexSorting(
                new SortByNameAsc(), new SortByPriorityDesc(), jobs).get(2), is(new Job("two", 2)));
    }
    ...
    public void compareDescNameAscPriority() {
        List<Job> jobs = List.of(new Job("two", 3), new Job("one", 1), new Job("two", 2));
        assertThat(complexSorting(
                new SortByNameDesc(), new SortByPriorityAsc(), jobs).get(0), is(new Job("two", 2)));
    }
    ...
    public void compareDescNameDescPriority() {
        ...
        assertThat(complexSorting(
                new SortByNameDesc(),
                new SortByPriorityDesc(), jobs).get(0), is(new Job("two", 3)));
    }
    ...
    public void compareDescNameAscPriorityReversedControl() {
        ...
        assertThat(complexSorting(
                new SortByNameDesc(),
                new SortByPriorityAsc().reversed(), jobs).get(0), is(new Job("two", 3)));
    }
